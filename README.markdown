...
Next step is to FORK this repository. Clone it to your local machine, and make sure you do a find-and-replace across the entire repo for `chriscooper` and replace it with the name of your User folder. Then go into the .gitconfig file and make sure you change your Git username and email address to your relevant details, unless you want me taking credit for your commits :)
...
Next, use the homesick command to clone this repository:
    ...
    homesick clone git://github.com/chriscooper/home-files.git
